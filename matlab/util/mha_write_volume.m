function mha_write_volume(filename, img, resolution, offset, transform)
...
if(ndims == 2)
    ...
    fprintf(fid, 'TransformMatrix = %1.12e %1.12e %1.12e %1.12e\n', ...
...
elseif(ndims == 3)
    ...
    fprintf(fid, 'TransformMatrix = %1.12e %1.12e %1.12e %1.12e %1.12e %1.12e %1.12e %1.12e %1.12e\n', ...
